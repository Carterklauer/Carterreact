...
export default function Colton(){
  ...
  <main>
    ...
    <Popup visible={CheckID("pic2")} onClose={false} style={{width:500, height:800}} id="pic2">
      <div className="close-button" onClick={()=>ClosePopup()}>&times;</div>
    </Popup>
    <img className="portrait" src="https://cdn.glitch.com/1760db9d-c13a-4b0a-a542-608419c30c2b%2F65977661_649244112259034_4839865523351060480_n.jpg?v=1602466482409" border={0} alt="Colton playing baseball 3." onClick={()=>OpenPopup("pic3")}/>
